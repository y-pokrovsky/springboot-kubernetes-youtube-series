...
class BookmarkControllerTest {
    ...
    void setUp() {
        ...
        bookmarks.add(new Bookmark(null, "DevOpsBookmarks", "http://devopsbookmarks.com/", Instant.now()));
        bookmarks.add(new Bookmark(null, "Kubernetes docs", "https://kubernetes.io/docs/home/", Instant.now()));
        bookmarks.add(new Bookmark(null, "Expressjs", "https://express.js.com/", Instant.now()));
